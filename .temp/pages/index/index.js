...
export default class Index extends Taro.Component {
  ...
  render() {
    ...
    return <View className={current == '0' ? 'index' : 'white-index'}>
        <View className="navbar" style={style}></View>
        {current == '0' ? <Main /> : <User />} 
        <AtTabBar fixed tabList={[{ title: '主页', iconType: 'home' }, { title: '我的', iconType: 'user' }]} onClick={this.handleClick.bind(this)} current={current} />
      </View>;
  }
}