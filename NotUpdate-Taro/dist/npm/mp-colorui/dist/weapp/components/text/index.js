(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["npm/mp-colorui/dist/weapp/components/text/index"],{

/***/ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./node_modules/mp-colorui/dist/weapp/components/text/index.tsx?taro&type=script&parse=COMPONENT&":
/*!*****************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./node_modules/mp-colorui/dist/weapp/components/text/index.tsx?taro&type=script&parse=COMPONENT& ***!
  \*****************************************************************************************************************************************************************************************/
...
__webpack_require__(/*! ./index.scss */ "./node_modules/mp-colorui/dist/weapp/components/text/index.scss");
...
var LINE_SPACING = {
  small: 95 * _index.screenPercent,
  normal: 115 * _index.screenPercent,
  large: 155 * _index.screenPercent
};
var FONT_SPACING = {
  small: 5,
  normal: 10,
...
var ClText = (_temp2 = _class = function (_Taro$Component) {
  _inherits(ClText, _Taro$Component);
  ...
  function ClText() {
    ...
    _classCallCheck(this, ClText);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ClText.__proto__ || Object.getPrototypeOf(ClText)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "props", "children"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(ClText, [{
    key: "_constructor",
    value: function _constructor(props) {
      _get(ClText.prototype.__proto__ || Object.getPrototypeOf(ClText.prototype), "_constructor", this).call(this, props);
    ...
    value: function _createData() {
      ...
      var size = (0, _index.isNumber)(props.size) ? props.size : props.size || "normal";
      var fontSize = (0, _index.isNumber)(size) ? (0, _taroWeapp.pxTransform)(size) : (0, _taroWeapp.pxTransform)(_model.pxMap[size || "normal"] * _index.screenPercent);
      // const sizeClassName = `text-${SIZE[size === "normal" ? "df" : size]}`;
      var textColorClassName = props.textColor ? _model.TEXT_COLOR_LIST[props.textColor || "black"] : "";
      var bgColorClassName = props.bgColor ? _model.BG_COLOR_LIST[props.bgColor || "white"] : "";
      ...
      var anonymousState__temp = (0, _index.classNames)(" " + textColorClassName + " " + bgColorClassName + " " + cutClassName + " " + alignClassName, props.className);
      var anonymousState__temp2 = (0, _taroWeapp.internal_inline_style)(Object.assign({
        lineHeight: lineSpacing === "none" ? "normal" : (0, _taroWeapp.pxTransform)((0, _index.isNumber)(lineSpacing) ? lineSpacing : LINE_SPACING[lineSpacing]),
        letterSpacing: fontSpacing === "none" ? "normal" : (0, _taroWeapp.pxTransform)((0, _index.isNumber)(fontSpacing) ? fontSpacing : FONT_SPACING[fontSpacing]),
        fontWeight: props.fontWeight,
        fontSize: fontSize
      }, props.style));
      var anonymousState__temp3 = (0, _index.classNames)([{
  ...
  return ClText;
}(_taroWeapp2.default.Component), _class.$$events = [], _class.$$componentPath = "node_modules/mp-colorui/dist/weapp/components/text/index", _temp2);
...
exports.default = ClText;

Component(__webpack_require__(/*! @tarojs/taro-weapp */ "./node_modules/@tarojs/taro-weapp/index.js").default.createComponent(ClText));

/***/ }),

/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=/Users/synapse/vscode_workspace/NodeJS_project/NotUpdate/NotUpdate-Taro/node_modules&outputPath=npm!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./node_modules/mp-colorui/dist/weapp/components/text/index.tsx?taro&type=template&parse=COMPONENT&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=/Users/synapse/vscode_workspace/NodeJS_project/NotUpdate/NotUpdate-Taro/node_modules&outputPath=npm!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./node_modules/mp-colorui/dist/weapp/components/text/index.tsx?taro&type=template&parse=COMPONENT& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "npm/mp-colorui/dist/weapp/components/text/index.wxml";

/***/ }),

/***/ "./node_modules/mp-colorui/dist/weapp/components/text/index.scss":
/*!***********************************************************************!*\
  !*** ./node_modules/mp-colorui/dist/weapp/components/text/index.scss ***!
  \***********************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/mp-colorui/dist/weapp/components/text/index.tsx":
/*!**********************************************************************!*\
  !*** ./node_modules/mp-colorui/dist/weapp/components/text/index.tsx ***!
  \**********************************************************************/
/*! no static exports found */
...
/* harmony import */ var _index_tsx_taro_type_template_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.tsx?taro&type=template&parse=COMPONENT& */ "./node_modules/mp-colorui/dist/weapp/components/text/index.tsx?taro&type=template&parse=COMPONENT&");
/* harmony import */ var _index_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.tsx?taro&type=script&parse=COMPONENT& */ "./node_modules/mp-colorui/dist/weapp/components/text/index.tsx?taro&type=script&parse=COMPONENT&");
...
/***/ "./node_modules/mp-colorui/dist/weapp/components/text/index.tsx?taro&type=script&parse=COMPONENT&":
/*!********************************************************************************************************!*\
  !*** ./node_modules/mp-colorui/dist/weapp/components/text/index.tsx?taro&type=script&parse=COMPONENT& ***!
  \********************************************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/mp-colorui/dist/weapp/components/text/index.tsx?taro&type=template&parse=COMPONENT&":
/*!**********************************************************************************************************!*\
  !*** ./node_modules/mp-colorui/dist/weapp/components/text/index.tsx?taro&type=template&parse=COMPONENT& ***!
  \**********************************************************************************************************/
/*! no static exports found */
...
},[["./node_modules/mp-colorui/dist/weapp/components/text/index.tsx","runtime","taro","vendors"]]]);